...
function sumArray(sumArr) {
    //eslint-disable-line
    let sum3 = sum(testArray[0], testArray[1]);
    let sum4 = sum(sum3[0], testArray[2]);
    //console.log(testArray);
    return [sum4[0], `${testArray[0]},${testArray[1]},${testArray[2]} was passed in as an array of numbers, and ${sum4[0]} is their sum.`];
}
...
function multiplyArray(multArr) {
    //eslint-disable-line
    let mult3 = multiply(testArray[0], testArray[1]);
    let mult4 = multiply(mult3[0], testArray[2]);
    //console.log(testArray);
    return [mult4[0], `The numbers ${testArray[0]},${testArray[1]},${testArray[2]} have a product of ${mult4[0]}.`];
}
